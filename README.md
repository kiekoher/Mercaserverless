...
- **Integración con IA (LLM):** Funcionalidad controlada que permite a los supervisores generar un resumen de texto amigable y motivador de una ruta utilizando un modelo de lenguaje grande (simulado con OpenAI).
...
- **IA / LLM:** [OpenAI API](https://openai.com/) (simulada en el endpoint de resumen)
...
2.  **Crea el archivo de variables de entorno:**
    ...
    ```
    Luego, rellena las variables con tus propias credenciales de Supabase y OpenAI:
    ```
